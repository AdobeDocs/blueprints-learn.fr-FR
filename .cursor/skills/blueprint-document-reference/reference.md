...
|------|---------|--------------------|
| **Présentation/hub** | Introduit un produit ou une zone ; liens vers des plans directeurs de scénario | e.g. `overview.md`, `journey-optimizer-overview.md` |
...
| **Considérations relatives à l’implémentation** | Lorsqu’il existe des avertissements importants | Sous-sections (par exemple, considérations d’identité, personnalisation basée sur les attributs). Puces ou paragraphes courts ; liaison pour plus de profondeur. |
