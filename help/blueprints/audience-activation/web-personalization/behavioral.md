...
short-description: Découvrez comment personnaliser en fonction du comportement en ligne et des données d’audience.
...
# Plan directeur de personnalisation web et mobile comportementale
...
<img src="assets/behavioral_personalization.svg" alt="Architecture de référence pour le plan directeur de personnalisation web" style="width:90%; border:1px solid #4a4a4a; margin-bottom: 15px;" class="modal-image" />
