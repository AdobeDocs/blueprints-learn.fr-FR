...
[Reportez-vous au plan directeur de SDK spécifique à l’application.](../../experience-platform/deployment/appsdk.md)

## Considérations relatives à la mise en œuvre

Conditions préalables requises pour les identités

* Toute identité principale peut être utilisée lors de l’utilisation du modèle de mise en oeuvre 1 décrit ci-dessus avec la variable [!DNL Edge Network] et SDK Web. La première personnalisation de connexion nécessite que l’identité principale du jeu de requêtes de personnalisation corresponde à l’identité principale du profil de Real-time Customer Data Platform.
