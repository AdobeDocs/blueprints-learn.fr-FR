---
title: Présentation de la personnalisation web/mobile - Adobe Target et RTCDP
...
* En utilisant la variable [!DNL Edge Network] avec le SDK Web/Mobile. La segmentation Edge en temps réel nécessite d’adopter le modèle d’implémentation du SDK web/mobile ou de l’API Edge.
...
* [Voir [!DNL Edge Network] API du serveur](https://experienceleague.adobe.com/docs/experience-platform/edge-network-server-api/overview.html?lang=fr) pour une mise en oeuvre basée sur l’API d’Adobe Target avec le profil Edge.
...
1. [Configurez la variable [!DNL Edge Network] avec Edge Datastream](https://experienceleague.adobe.com/docs/experience-platform/edge/fundamentals/datastreams.html?lang=fr)
