...
<img src="assets/known_activation.png" alt="Architecture de référence pour le scénario d’activation en entreprise" style="width:90%; border:1px solid #4a4a4a" class="modal-image" />
