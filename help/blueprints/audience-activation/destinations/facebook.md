...
<img src="../assets/facebook.svg" alt="Architecture de référence d’activation d’audience Facebook personnalisée" style="width:90%; border:1px solid #4a4a4a" class="modal-image" />
