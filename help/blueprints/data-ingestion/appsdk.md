...
<img src="assets/app_sdk_flow.svg" alt="Architecture de référence pour une implémentation à l’aide de SDK spécifiques à l’application" style="width:90%; border:1px solid #4a4a4a" />
