...
<img src="../experience-platform/assets/aep_data_flow.png" alt="Architecture de référence pour le plan directeur de la préparation et de l’ingestion de données" style="border:1px solid #4a4a4a" />
