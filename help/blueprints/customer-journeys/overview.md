...
|---|---|---|
| **[Journey Optimizer](journey-optimizer.md)** | Conçue de manière native au-dessus de la fonction [!DNL Experience Platforms] Real-Time Customer Profile permet aux équipes marketing de réagir en temps réel à la modification du comportement des clients et de répondre à leurs besoins sur n’importe quel canal, à tout moment. | <img src="assets/ajo-architecture.svg" alt="Architecture de référence du plan directeur Journey Optimizer" style="width:75%; border:1px solid #4a4a4a" class="modal-image" /> |
