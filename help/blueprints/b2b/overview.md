---
title: Plans directeurs B2B Analytics, Activation et Marketing
...
ht-degree: 67%
---
# Plans directeurs B2B Analytics, Activation et Marketing
...
| **[Audience and Profile Activation B2B](b2b-audience-profile-activation.md)** | <ul><li>Créer et activer des audiences de comptes et de personnes à partir de profils B2B unifiés sur plusieurs canaux et destinations</li></ul> | <ul><li>Adobe Real-Time Customer Data Platform B2B edition</li><li>Adobe Journey Optimizer B2B edition</li><li>Adobe Customer Journey Analytics B2B edition</li></ul> |
| **[Activation de compte B2B](b2b-account-activation.md)** | <ul><li>Activez les audiences de compte vers des destinations publicitaires et un stockage dans le cloud pour le ciblage, la sensibilisation des ventes et l’analyse</li></ul> | <ul><li>Adobe Real-Time Customer Data Platform B2B edition</li></ul> |
| **[Marketing et gestion de Parcours par groupe d&#39;achat](/help/blueprints/b2b/b2b-buying-group-journeys.md)** | <ul><li>Concevez et créez un parcours de compte qui qualifie les prospects pour un groupe d’achats qui augmente l’efficacité de l’activité marketing dans la qualification des prospects aux opportunités de vente</li></ul> | <ul><li>Adobe Journey Optimizer B2B edition</li><li>Édition B2B Adobe Real-time Customer Data Platform</li><li>Adobe Marketo Engage</li></ul> |
