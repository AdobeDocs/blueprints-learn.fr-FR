...
>[!TIP]
>Ce plan directeur est également disponible en tant que [modèle de cas d’utilisation](/help/blueprints/use-case-patterns/b2b/marketo-data-journeys.md) sous Activation et marketing B2B.
...
1. Implémentez des [règles de liaison de graphiques d’identités](https://experienceleague.adobe.com/en/docs/experience-platform/identity/features/identity-graph-linking-rules/overview) pour les personnes :
...
1. Activez les jeux de données Personne, Entreprises, Opportunités et Activités pour les [profils](https://experienceleague.adobe.com/en/docs/experience-platform/catalog/datasets/user-guide#enable-profile)
1. Définir votre première audience [compte](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/audiences/account-audience-overview)
...
* **Utiliser les champs d’identité par défaut :**
   * _e-mail_ et _b2b_ person_ doivent être conservés en tant que champs d’identité dans le schéma Personne pour prendre en charge le regroupement d’identités et l’activation de l’audience.
...
* **Utiliser les mappages par défaut pour AJO B2B:**
   * Adoptez les [mappages de champs standard](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/admin/xdm-field-management/field-mapping) pour Journey Optimizer B2B edition afin d’assurer la compatibilité avec la logique de groupe d’achats et l’orchestration des parcours.
...
* [Adobe Journey Optimizer B2B edition - Description du produit](https://helpx.adobe.com/legal/product-descriptions/adobe-journey-optimizer-b2b.html)
...
* [Adobe Marketo Engage - Description du produit](https://helpx.adobe.com/legal/product-descriptions/adobe-marketo-engage---product-description.html#performance-guardrails)
...
* Mécanismes De Sécurisation De [Real-Time CDP](https://experienceleague.adobe.com/en/docs/experience-platform/rtcdp/guardrails/overview?lang=en)
...
* [Documentation de Adobe Journey Optimizer B2B edition](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/guide-overview)
* [Gestion des champs XDM (Journey Optimizer B2B edition)](https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/admin/xdm-field-management/xdm-field-management)
