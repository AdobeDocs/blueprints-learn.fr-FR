...
description: Installez Postman et familiarisez-vous avec ses collections, environnements et interfaces avant de démarrer les ateliers d’API bootcamp.
doc-type: article
...
Page de téléchargement de ![Postman pour installer l’application de bureau ou utiliser la version web](assets/postman-installation-download-page.png)
...
![Interface Postman mettant en surbrillance la barre latérale, l’en-tête, la zone de travail principale et le pied de page](assets/postman-installation-interface-overview.png "Interface Postman")
