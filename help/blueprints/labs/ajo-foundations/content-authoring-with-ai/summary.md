...
Tout au long de ce cours, vous avez exploré le parcours complet de la création de campagnes personnalisées et conformes à la marque dans Adobe Journey Optimizer. De la création de blocs de contenu réutilisables à l’application d’améliorations pilotées par l’IA, en passant par la configuration de variations dynamiques et l’exécution de simulations, vous avez acquis une expérience pratique des outils qui vous permettent de vous assurer que vos communications ont un impact et sont cohérentes. Lorsque vous vous préparez à appliquer ces compétences dans des scénarios réels, tenez compte des points clés suivants :
...
- [ ] Avez-vous créé et configuré la marque Connection 5G ?
- [ ] Avez-vous créé et appliqué des fragments d’en-tête/de pied de page ?
- [ ] Avez-vous utilisé l’assistant d’IA pour générer du contenu ?
- [ ] Avez-vous effectué des vérifications d’alignement de marque et résolu les problèmes ?
- [ ] Avez-vous testé votre parcours avec un profil de test et examiné l’e-mail ?
