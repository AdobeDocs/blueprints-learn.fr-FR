...
# Cas d’utilisation des plans directeurs d’expérience numérique

Quels de ces cas d’utilisation sont importants pour votre entreprise ? Découvrez quels plans directeurs d’expérience numérique répondent aux objectifs de votre entreprise.
...
<tr>
 ...
 <tr>
  ...
  <td rowspan="6" style="vertical-align: middle; border-left: 1px solid rgb(219,219,219); border-right:  1px solid rgb(219,219,219)">Données
 ...
 <tr>
  <td>Personnalisation basée sur des consultations antérieures de produit/contenu,
  affinité produit/contenu, attributs environnementaux, audience tierce
  données et données démographiques en plus des informations hors ligne telles que les transactions,
  données de fidélité et de gestion de la relation client, et informations modélisées.</td>
 </tr>
</table>