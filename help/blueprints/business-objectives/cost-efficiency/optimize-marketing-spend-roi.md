...
| KPI | Description |
| --- | --- |
| Économies | Réduction des dépenses marketing gaspillées grâce à un ciblage et une suppression améliorés |
| Coût d’acquisition client | Coût total d’acquisition d’un nouveau client, réduit par l’optimisation |
| Revenu incrémentiel | Chiffre d’affaires supplémentaire attribué aux efforts d’optimisation marketing |
