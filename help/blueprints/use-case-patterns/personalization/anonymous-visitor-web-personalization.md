...
**Fonctionnalité d’application :** AJO : création de messages, AJO : expérimentation de contenu (option B), AJO : prise de décision (option C)
...
- Maximum de 30 emplacements par décision (option C) — [Mécanismes de sécurisation &#x200B;](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/get-started/guardrails)
