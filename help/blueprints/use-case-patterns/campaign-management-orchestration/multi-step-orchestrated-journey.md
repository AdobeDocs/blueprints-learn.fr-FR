...
- Maximum de **500 parcours actifs** par sandbox — [Mécanismes de sécurisation Journey Optimizer](https://experienceleague.adobe.com/fr/docs/journey-optimizer/using/get-started/guardrails)
