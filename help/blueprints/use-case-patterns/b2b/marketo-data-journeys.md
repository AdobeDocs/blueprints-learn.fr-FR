...
![Architecture de solution pour Journey Optimizer B2B edition avec les données Marketo](/help/blueprints/b2b/assets/ajo-b2b-architecture-simplified.png){zoomable="yes"}
