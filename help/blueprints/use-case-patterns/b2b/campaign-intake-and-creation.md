...
<table> 
  ...
  <tr> 
   <td>E-mail</td>
   <td>· Objet du courrier électronique<br />
· Date prévue<br />
· Copie du courriel<br />
· Call to action<br />
· Image(s) : les URL d’AEM Assets peuvent être directement référencées pour une utilisation dans Marketo.<br />
...
· Noms de conférenciers<br />
· Titres des intervenants<br />
· Images de haut-parleur<br />
· Les courriels nécessaires (invitation, confirmation, rappel, suivi)<br />
· Image(s) d'en-tête d'e-mail<br />
· Critères de qualification de l'audience</td>
  </tr>
  <tr>
   <td>Nurture</td>
   <td>· Nombre de courriels<br />
· Copie du courriel<br />
