...
**Fonctionnalités de l’application :** [!DNL RT-CDP B2B] : unification des profils de compte, résolution d’identité B2B, intégration [!DNL Marketo Engage], gouvernance des données B2B, évaluation de l’audience du compte
...
**Fonctionnalités de l’application :** [!DNL AJO B2B] : Configuration de l’intérêt de la solution, gestion des groupes d’achats
...
**Fonctionnalités de l’application :** [!DNL AJO B2B] : score de l’engagement, qualification du compte
...
**Fonctionnalités de l’application :** [!DNL AJO B2B] : Journey Orchestration du compte, création d’e-mails B2B, gestion des canaux SMS
...
**Fonctionnalités de l’application :** [!DNL AJO B2B] : Configuration des alertes de ventes, Informations sur les ventes CRM ; [!DNL RT-CDP B2B] : Configuration de la destination du compte, Audience Activation du compte
...
**Fonctionnalités de l’application :** [!DNL AJO B2B] : Tableaux de bord B2B Analytics
...
- Les surfaces de canal e-mail sont limitées à 10 par type de canal par sandbox : [mécanismes de sécurisation &#x200B;](https://experienceleague.adobe.com/fr/docs/journey-optimizer/using/get-started/guardrails)
