...
---
# Modèle de section de cas d’utilisation du secteur

Chaque cas d’utilisation d’un fichier de présentation du secteur suit cette structure exacte.
...
### Exemple De Base (Vente Au Détail)
